...
const Hoodies = () => {
  const products = Array(8).fill({
    ...
    sizes: "S, M, L, XL",
    image:
      "https://m.media-amazon.com/images/I/31ueUPc0ZRL._SY445_.jpg",
    slug: "wear-the-code",
  });
    ...
    <section className="text-gray-600 body-font">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-gray-900">Hoodies Collection</h1>
          <p className="mt-2 text-gray-500">
            Premium coding hoodies for developers
          </p>
        </div>
