...
const SLug = () => {
  ...
  const checkServiceabilty = async () => {
    ...
    if (pinJson.data.includes(parseInt(pin))) {
      setService(true);
    } else {
      setService(false);
    }
        ...
        <div className="container px-5 py-16 mx-auto">
          <div className="lg:w-4/5 mx-auto flex flex-wrap">
            <img
              ...
              src="https://m.media-amazon.com/images/I/71PlojKOn2L._SX679_.jpg"
            />
             ...
             CodesWear
              ...
              <div className="pin mt-6 flex space-x-2 text-md ">
                <input
                  ...
                  type="text"
                  className=" px-1 md:px-2 border-2 border-gray-400  rounded-md"
                />
                <button
                  onClick={checkServiceabilty}
                  className="flex ml-12 text-white bg-pink-500 border-0 py-1 md:py-2  px-2 md:px-6 focus:outline-none hover:bg-pink-600 rounded"
                >
                  Check
                </button>
              </div>

              {/* msg for servicebilty  */}
